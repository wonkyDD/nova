...
impl HeapMarkAndSweep for Object {
    ...
    fn sweep_values(&mut self, compactions: &CompactionLists) {
        match self {
            ...
            Self::BuiltinConstructorFunction => todo!(),
            ...
            Self::BuiltinPromiseRejectFunction(data) => data.sweep_values(compactions),
            Self::BuiltinPromiseResolveFunction => todo!(),
            ...
            Self::ECMAScriptAsyncFunction => todo!(),
            Self::ECMAScriptAsyncGeneratorFunction => todo!(),
            Self::ECMAScriptConstructorFunction => todo!(),
            Self::ECMAScriptFunction(data) => data.sweep_values(compactions),
            Self::ECMAScriptGeneratorFunction => todo!(),
